...
export const ABOUT_US_INFO = {
  ...
  story:
    "Facing North Travel & Tours is a leading travel company in Pakistan, offering customized tours that showcase the natural beauty, rich cultural heritage, and unique way of life of the country's northern regions. With experienced and knowledgeable guides who are dedicated to providing an authentic and sustainable travel experience, the company works closely with local communities and organizations to ensure their tours have a positive impact on the environment and local economy. From stunning mountain landscapes to traditional villages and local communities, Facing North Travel & Tours provides unforgettable travel experiences.",
  mission:
